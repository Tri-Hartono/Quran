      ...
      <div className="py-10 relative">
         ...
         >
            ...
            <div className="text-center text-3xl">
               Surah : {dataSurah.data.namaLatin}
            </div>
            <div className="space-y-4 py-10">
               {dataSurah.data.ayat.map((item: Ayat, index: number) => (
                  <div
                     key={index}
                     className="space-y-6 border-t pt-6  border-blue-500  relative"
                  >
                     <h2 className="absolute top-0 left-0 py-1 px-2 bg-blue-500  text-white rounded-br-xl">
                        {item.nomorAyat}
                     </h2>
                     <h2 className="text-right leading-loose mb-2 py-4 text-2xl font-semibold">
                        {item.teksArab}
                     </h2>
                     <div className="space-y-2">
                        <p className="font-semibold">{item.teksLatin}</p>
            ...
            <div className="flex gap-2  flex-col md:flex-row">
               ...
               {isSuratSelesai ? (
                  <h2>Ini adalah surat terakhir</h2>
               ) : (
                  <SuratNavigation
         ...
         <div
            ...
            className="p-2 bg-blue-400 text-zinc-100 rounded-md fixed z-20 right-4 bottom-10"
         >
