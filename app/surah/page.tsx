    ...
    <div>
      <div className="flex items-center relative gap-2 py-4 w-auto justify-end overflow-x-hidden ">
        <input
          ...
          className={`text-zinc-900 rounded-md px-4 py-2 focus:outline-none bg-white w-full transition-all duration-300  ${active ? 'scale-100' : 'scale-0 '} `}
        />
        <div onClick={() => setActive(!active)} className="p-2 bg-blue-400 text-zinc-100 rounded-md">
